...
var MainNetParams = chaincfg.Params{
	...
	TargetTimespan:           time.Second * 5, // 5 seconds
	TargetTimePerBlock:       time.Second * 5, // 5 seconds
	...
	// BIP 173.
	Bech32HRPSegwit: "xst", // always block for mainnet

	// Address encoding magics
	PubKeyHashAddrID:        0x6f, // starts with B
	ScriptHashAddrID:        0xc4, // starts with C
